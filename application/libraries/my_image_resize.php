...
class My_image_resize{
	...
	public function setImage($fileName, $extension){
	...
	public function getImageResource($imageQuality="70"){
		...
		switch($extension)
		{
			...
			case 'png':
				$scaleQuality = round(($imageQuality/100) * 8);
				$invertScaleQuality = 8 - $scaleQuality;
